...
function unconjugateRecursive(
  ...
  const isDictionaryForm =
    ...
    // LOCAL CHANGE (see PROVENANCE.md): adjectives are a terminal form here
    // too. The table already carries 44 adjective rules; upstream computes
    // them and then discards every result, because this package is about
    // verbs. Without this line 高くない deinflects to nothing.
